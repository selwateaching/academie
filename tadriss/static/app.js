...
function generateContentLocal(type,p,lev,sub){
  const lang=language();const ar=lang==='ar';const en=lang==='en';
  const titles={
  ...
  if(type==='assessment')sections.push(ar?['الباريم','التمرين 1: 5 ن · التمرين 2: 7 ن · التمرين 3: 8 ن']:en?['Grading scale','Exercise 1: 5 pts · Exercise 2: 7 pts · Exercise 3: 8 pts']:['Barème','Exercice 1 : 5 pts · Exercice 2 : 7 pts · Exercice 3 : 8 pts']);
  if(type==='course')sections.push(ar?['تمارين تطبيقية','تمرين 1، تمرين 2، تمرين 3 مع التصحيح.']:en?['Corrected exercises','Exercise 1, exercise 2 and exercise 3 with correction.']:['Exercices corrigés','Exercice 1, exercice 2 et exercice 3 avec correction.']);
