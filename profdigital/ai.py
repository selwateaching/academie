...
MODEL_ID = os.environ.get("PROFDIGITAL_AI_MODEL", "claude-opus-5")
...
LANG_INSTRUCTIONS = {
    ...
    "en": "Rédige entièrement en anglais (English), avec un niveau adapté à des élèves français apprenant l'anglais comme langue étrangère. Le champ \"rtl\" doit être false.",
    "es": "Rédige entièrement en espagnol (español), avec un niveau adapté à des élèves français apprenant l'espagnol comme langue étrangère. Le champ \"rtl\" doit être false.",
...
DEFAULT_LANG_INSTRUCTION = (
    ...
    "l'anglais, espagnol si la matière est l'espagnol, arabe standard moderne si la "
    "matière est l'arabe, français sinon. Mets \"rtl\" à true uniquement si tu écris en arabe."
)

SYSTEM_PROMPT = (
    "Tu es ProfDigital IA, un assistant pédagogique pour les enseignants du système "
    "scolaire français (école primaire, collège, lycée). Tu réponds uniquement avec "
...
def build_prompt(doc_type, level, subject, lang, user_prompt):
    ...
    return f"""Génère {label}, conforme aux programmes officiels de l'Éducation nationale française.
